...
export type TreeOperation = TreeEdit | TransactionBoundary | UndoRedo | SchemaEdit;
...
export type FuzzSchemaOpType = BooleanOp | StringOp | NodeUUIDOp;
